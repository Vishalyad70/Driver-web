...
export const FETCH_CAR_PLATE_ERROR = "FETCH_CAR_PLATE_ERROR";
export const FETCH_CAR_PLATE_LIST = "FETCH_CAR_PLATE_LIST";
export const SET_CAR_PLATE_LIST = "SET_CAR_PLATE_LIST";
export const RESET_CAR_PLATE_LIST = "RESET_CAR_PLATE_LIST";

export const FETCH_COMPLAINT_ERROR = "FETCH_COMPLAINT_ERROR";
export const FETCH_COMPLAINT_LIST = "FETCH_COMPLAINT_LIST";
export const SET_COMPLAINT_LIST = "SET_COMPLAINT_LIST";
